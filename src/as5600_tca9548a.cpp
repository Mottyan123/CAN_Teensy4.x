...
static AS5600 as5600_5;
static AS5600 as5600_6;
static AS5600 as5600_7;
static AS5600 as5600_8;
static AS5600 as5600[8] = {as5600_1, as5600_2, as5600_3, as5600_4, as5600_5, as5600_6, as5600_7, as5600_8};
...
//現在の角度を取得する
void get_now_angle(float current_angle[8],float offset2[8]){
  for (int i = 0; i < 8; i++){
      I2CMux.openChannel(i);
      current_angle[i] = (as5600[i].getCumulativePosition() * AS5600_RAW_TO_DEGREES)+offset2[i];
      I2CMux.closeChannel(i);
  }
}